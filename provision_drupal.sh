...
apt-get install -y mg nginx php5-fpm php5-mysql php5-gd php5-curl php5-mcrypt php5-cli php-console-table php-pear php-codecoverage phpunit-mock-object keychain zsh subversion git curl nfs-kernel-server zip unzip exuberant-ctags
